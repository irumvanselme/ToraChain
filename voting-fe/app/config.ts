 ...
 * the voter was headed. We pass the *full* URL (origin + path + search) because
 * this SPA and the auth service may live on different domains; the auth side
 * honors full URLs whose origin is trusted, so a bare path would not be enough
 * to land back on this app.
 */
